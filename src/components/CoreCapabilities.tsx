...
const capabilities = [
  {
    ...
    desc: "Designing interactive dashboards in Tableau and Excel to uncover trends and support business decision-making.",
  ...
  {
    title: "Data Analysis",
    desc: "Analyzing structured datasets to identify patterns, generate insights, and solve business problems effectively.",
  ...
  },
  {
    ...
    desc: "Preparing raw data through cleaning, formatting, and SQL-based transformation for accurate analysis.",
    icon: <Database className="w-5 h-5 text-blue-400" />,
    stat: "15K+",
    statLabel: "Rows Transformed",
  },
  {
    title: "Business Intelligence",
    desc: "Building KPI-driven reports and dashboards to track performance and enable strategic decisions.",
